                ...
                <CardContent>
                  <Table>
                    <TableBody>
                      ...
                      <TableRow>
                        <TableCell className="font-medium">
                          {dict.details.purchaseDate}
                        </TableCell>
                        <TableCell>
                          {itemWithFormattedDates.purchaseDateFormatted}
                        </TableCell>
                      </TableRow>
                      ...
                      {item.lastReview && (
                        <TableRow>
                          <TableCell className="font-medium">
                            {dict.details.lastReview}
                          </TableCell>
                          <TableCell>
                            {itemWithFormattedDates.lastReviewFormatted}
                          </TableCell>
                        </TableRow>
                      )}
                      ...
                      {item.connectionType && (
                        <TableRow>
                          <TableCell className="font-medium">
                            {dict.details.connectionType}
                          </TableCell>
                          <TableCell>
                            {dict.connectionTypes[item.connectionType]}
                          </TableCell>
                        </TableRow>
                      )}
                  ...
                  <Table>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          {itemWithFormattedDates.createdAtFormatted}
                        </TableCell>
                      </TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          {extractNameFromEmail(item.createdBy)}
                        </TableCell>
                      </TableRow>

                      <TableRow>
                        <TableCell className="font-medium">
                          {dict.details.editedAt}
                        </TableCell>
                        <TableCell>
                          {itemWithFormattedDates.editedAtFormatted}
                        </TableCell>
                      </TableRow>

                      <TableRow>
                        <TableCell className="font-medium">
                          {dict.details.editedBy}
                        </TableCell>
                        <TableCell>
                          {extractNameFromEmail(item.editedBy)}
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    ...
                    {dict.details.currentAssignment}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  {item.currentAssignment ? (
                    <Table>
                      <TableBody>
                        <TableRow>
                          <TableCell className="font-medium">
                            {dict.details.assignedTo}
                          </TableCell>
                          <TableCell>
                            {item.currentAssignment.assignment.type ===
                            "employee" ? (
                              <>
                                {
                        ...
                        <TableRow>
                          <TableCell className="font-medium">
                            {dict.details.assignedAt}
                          </TableCell>
                          <TableCell>
                            {
                              itemWithFormattedDates.currentAssignment
                                ?.assignedAtFormatted
                            }
                          </TableCell>
                        </TableRow>
                        ...
                        <TableRow>
                          <TableCell className="font-medium">
                            {dict.details.assignedBy}
                          </TableCell>
                          <TableCell>
                            {extractNameFromEmail(
                              item.currentAssignment.assignedBy,
                            )}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center">
                      ...
                      {dict.details.assignmentHistory}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {itemWithFormattedDates.assignmentHistory.map(
                          (record: any, index: number) => (
                            <TableRow key={index}>
                                ...
                                {record.assignment.type === "employee" ? (
                                  <>
                                    <div className="font-medium">
                                      {record.assignment.employee.firstName}{" "}
                                      {record.assignment.employee.lastName}
                                    </div>
                              ...
                              <TableCell>
                                {record.assignedAtFormatted}
                              </TableCell>
                              <TableCell>
                                {record.unassignedAtFormatted || "-"}
                              </TableCell>

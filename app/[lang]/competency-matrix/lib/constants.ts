...
export const PROCESS_AREA_LABELS: Record<ProcessArea, I18nString> = {
  ...
  coating: { pl: "Powlekanie", de: "Beschichtung", en: "Coating" },
  ...
  additional: {
    pl: "Kompetencje dodatkowe",
    de: "Zusätzliche Kompetenzen",
    en: "Additional Competencies",
  },
  management: { pl: "Zarządzanie", de: "Management", en: "Management" },
  "soft-skills": {
    pl: "Kompetencje miękkie",
    de: "Soft Skills",
    en: "Soft Skills",
  },
};
...
export const CERTIFICATION_TYPE_LABELS: Record<CertificationType, I18nString> =
  {
    ...
    "bhp-specialist": {
      pl: "Specjalista BHP",
      de: "Arbeitssicherheitsspezialist",
      en: "H&S Specialist",
    },
    "fire-inspector": {
      pl: "Inspektor p.poż.",
      de: "Brandschutzinspektor",
      en: "Fire Inspector",
    },
...
export const EDUCATION_LEVEL_LABELS: Record<EducationLevel, I18nString> = {
  ...
  "secondary-general": {
    pl: "Średnie ogólne",
    de: "Allgemeine Sekundarstufe",
    en: "Secondary (general)",
  },
  "secondary-specialized": {
    pl: "Średnie kierunkowe",
    de: "Fachsekundarstufe",
    en: "Secondary (specialized)",
  },
  "higher-general": {
    pl: "Wyższe ogólne",
    de: "Allgemeines Hochschulstudium",
    en: "Higher (general)",
  },
  "higher-specialized": {
    pl: "Wyższe kierunkowe",
    de: "Fachstudium",
    en: "Higher (specialized)",
  },
};
...
export const EVALUATION_PERIOD_LABELS: Record<
  EvaluationPeriodKind,
  I18nString
> = {
  annual: { pl: "Roczna", de: "Jährlich", en: "Annual" },
  "pre-hire": {
    pl: "Przed zatrudnieniem",
    de: "Vor der Einstellung",
    en: "Pre-hire",
  },
  "probation-2m": {
    pl: "Okres próbny (2 mies.)",
    de: "Probezeit (2 Mon.)",
    en: "Probation (2 mo.)",
  },
  "probation-5m": {
    pl: "Okres próbny (5 mies.)",
    de: "Probezeit (5 Mon.)",
    en: "Probation (5 mo.)",
  },
  "contract-end": {

    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        switch (status) {
          ...
          case "closed":
            statusLabel = (
              <Badge variant="statusClosed">{dict.table.status.closed}</Badge>
            );
            break;
          case "rejected":
            statusLabel = (
          ...
          case "draft":
            statusLabel = (
              <Badge variant="statusDraft">{dict.table.status.draft}</Badge>
            );
            break;
          case "cancelled":
            statusLabel = (
          ...
          <Button variant="outline" size={"icon"} asChild>
            ...
            >
              ...
              <span className="sr-only">
                {deviation.status === "draft"
                  ? dict.table.actions.edit
                  : dict.table.actions.open}
              </span>
            </LocalizedLink>
          </Button>
        );
